...
export default function DenunciasPage() {
  ...
  useEffect(() => {
    const carregarDados = async () => {
      try {
        const res = await fetch("https://fizcalizavolpe-back-end.onrender.com/api/denuncias");
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("https://fizcalizavolpe-back-end.onrender.com/api/denuncias", {
        method: "POST",
